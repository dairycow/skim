...
class TestGenerateLST:
    ...
    def test_generate_lst_success(
        ...
        # Mock base64 decode
        mocker.patch(
            "skim.trading.brokers.ibkr_oauth.base64.b64decode",
        ...
        mocker.patch(
            "skim.trading.brokers.ibkr_oauth.PKCS1_v1_5_Cipher.new",
        ...
        mocker.patch(
            "skim.trading.brokers.ibkr_oauth.hmac.new",
            side_effect=mock_hmac_new,
        )
