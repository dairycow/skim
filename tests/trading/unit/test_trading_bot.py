...
def mock_trading_bot(mock_bot_config):
    ...
    with (
        ...
        patch("skim.trading.core.bot.IBKRMarketData") as mock_market_data_class,
        patch("skim.trading.core.bot.IBKROrders") as mock_orders_class,
        patch(
...
class TestTradingBot:
    ...
    async def test_init_instantiates_services_and_strategies(
        ...
        with (
            ...
            patch("skim.trading.core.bot.IBKRClient") as mock_ibkr_client_class,
            patch(
                "skim.trading.core.bot.IBKRMarketData"
            ) as mock_market_data_class,
            patch("skim.trading.core.bot.IBKROrders") as mock_orders_class,
            patch(
                "skim.trading.core.bot.IBKRGapScanner"
            ) as mock_scanner_service_class,
